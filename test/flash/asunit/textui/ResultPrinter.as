package asunit.textui {
	...
	public class ResultPrinter extends Sprite implements TestListener {
		...
		public function setShowStackTrace(bool:Boolean = true):void{
		...
		private function configureAssets():void {
			...
			addChild(textArea);
			println("AsUnit 3.0 by Luke Bayes and Ali Mills");
			println("dpdk de shit");
		...
		protected function printDefectTrace(booBoo:TestFailure):void {
			...
			println(booBoo.thrownException().getStackTrace());
		}
...
class SuccessBar extends Sprite {
	...
	private var failingColor:uint = 0xFF0000;
